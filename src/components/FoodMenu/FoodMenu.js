        ...
        <div className="food-menu">
            <div className="foodMenu__container">
                <div className="foodMenu__items-header">
                    <span onClick={()=>setFoodMenu('breakfast')}>Breakfast</span>
                    <span onClick={()=>setFoodMenu('lunch')} className="active">Lunch</span>
                    <span onClick={()=>setFoodMenu('dinner')}>Dinner</span>
                </div>
